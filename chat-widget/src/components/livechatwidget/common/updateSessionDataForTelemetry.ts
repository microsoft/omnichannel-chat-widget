...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const updateSessionDataForTelemetry = async (facadeChatSDK: any, dispatch: Dispatch<ILiveChatWidgetAction>) => {
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const updateConversationDataForTelemetry = async (facadeChatSDK: any, dispatch: Dispatch<ILiveChatWidgetAction>) => {
    if (facadeChatSDK && facadeChatSDK.getChatSDK()) {
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
