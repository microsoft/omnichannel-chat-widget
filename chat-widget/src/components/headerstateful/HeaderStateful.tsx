...
export const HeaderStateful = (props: IHeaderStatefulParams) => {
    ...
    const controlProps: IHeaderControlProps = {
        ...
        hideCloseButton: state.appStates.conversationState === ConversationState.Loading || state.appStates.conversationState === ConversationState.PostchatLoading || state.appStates.conversationState === ConversationState.Prechat || state.appStates.conversationState === ConversationState.ReconnectChat || headerProps?.controlProps?.hideCloseButton
    };
