...
import { defaultWebChatStatefulProps } from "./common/defaultProps/defaultWebChatStatefulProps";
...
export const WebChatContainerStateful = (props: IWebChatContainerStatefulProps) => {
    ...
    return (
        ...
        .ms_lcw_webchat_received_message a:active {
            color: ${props?.webChatProps?.receivedMessageAnchorColor ?? defaultWebChatStatefulProps.receivedMessageAnchorColor};
        } `}</style>
