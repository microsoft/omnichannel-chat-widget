...
import { defaultAdaptiveCardStyle } from "./common/defaultStyles/defaultAdaptiveCardStyle";
...
export const WebChatContainerStateful = (props: IWebChatContainerStatefulProps) => {
    ...
    return (
        ...
        .webchat__bubble__content>div#ms_lcw_webchat_adaptive_card {
            background: ${props?.adaptiveCardStyle?.background?? defaultAdaptiveCardStyle.background};
        }

        div[class="ac-textBlock"]>p{color:${props?.adaptiveCardStyle?.color?? defaultAdaptiveCardStyle.color};}
