...
| draggableChatWidgetProps | [IDraggableChatWidgetProps.ts](../../chat-widget/src/components/livechatwidget/interfaces/IDraggableChatWidgetProps.ts) | No | Controls the properties of draggable chat widget | - |
