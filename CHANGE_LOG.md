...
### Fixed
- [Bug 6618963] Classic widgets without customization JSON now use the readable default agent bubble colors instead of black text on the theme-colored background.
