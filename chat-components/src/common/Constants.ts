...
export const AriaLabels = class {
    ...
    public static readonly InputValidationPaneInput = "Please provide e-mail address to send transcript to. The transcript will be sent after the chat ends. Email address text area";
...
export const Texts = class {
    ...
    public static readonly InputValidationPaneTitleText = "Please provide e-mail address to send transcript to.";
